...
import com.fradera.cafeteriafradera.data.Postres

class AdapterPostres (
    private val items: MutableList<Postres>,
    private val onAddClick: (Postres) -> Unit
) : RecyclerView.Adapter<AdapterPostres.ViewHolder>() {
    ...
    fun updateList(newList: List<Postres>) {
        items.clear()
