...
import com.fradera.cafeteriafradera.data.Menjars

class AdapterMenjars (
    private val items: MutableList<Menjars>,
    private val onAddClick: (Menjars) -> Unit
    ) : RecyclerView.Adapter<AdapterMenjars.ViewHolder>() {
        ...
        fun updateList(newList: List<Menjars>) {
            items.clear()
